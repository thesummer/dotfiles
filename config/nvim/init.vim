...
" General {{{
    ...
    set clipboard=unnamedplus " Content of copy (yy) appears in system clipboard
...
"     set diffopt+=vertical,iwhite,internal,algorithm:patience,hiddenoff " ??? Check if that is what I want when using diff
    set laststatus=2 " show the status line all the time
    set scrolloff=3 " ??? do I like this?  set 7 lines to the cursors - when moving vertical
...
"    set shortmess+=c ???
    ...
    " display invisible characters with prettier characters
...
" 
    ...
    " FZF {{{
        Plug '$HOME/.dotfiles/contrib/fzf'
...
"        Plug 'sodapopcan/vim-twiggy'
        Plug 'junegunn/gv.vim' " git graph plugin
"    " }}}
" 
"    " UltiSnips {{{
