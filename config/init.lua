...
-- TODO: didn't have it before: Enable break indent
...
vim.keymap.set('n', '<C-e>', '3<C-e>', { desc = 'Scroll viewport faster' })
vim.keymap.set('n', '<C-y>', '3<C-y>', { desc = 'Scroll viewport faster' })

vim.keymap.set('n', '<silent> j', 'gj', { desc = 'Moving up and down work as you would expect' })
vim.keymap.set('n', '<silent> k', 'gk', { desc = 'Moving up and down work as you would expect' })
vim.keymap.set('n', '<silent> ^', 'g^', { desc = 'Moving up and down work as you would expect' })
vim.keymap.set('n', '<silent> $', 'g$', { desc = 'Moving up and down work as you would expect' })
...
require('lazy').setup({
  ...
  { 'numToStr/Comment.nvim', opts = {} },
  {
    'szw/vim-maximizer',
    config = function()
      vim.keymap.set('n', '<leader>m', ':MaximizerToggle!<cr>', { silent = true, desc = 'Maximize current window' })
    end,
  },
  ...
  },
  {
    ...
    init = function()
      ...
      vim.keymap.set('n', '<leader>q', ':BW<cr>', { silent = true, desc = 'Close current buffer' })
    end,
  },

  {
    ...
    init = function()
      ...
      -- vim.keymap.set('n', '<leader>c', ':ClangFormat<cr>', { silent = true, desc = 'Close current buffer' })
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>n', ':Neotree toggle reveal_force_cwd<cr>', { silent = true, desc = 'Toggle NeoTree file explorer' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ff', ':Telescope grep_string search=<C-r><C-w><cr>', { desc = '[ ] Find existing buffers' })
